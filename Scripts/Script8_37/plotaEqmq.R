...
dados <- read.csv("simetrica100_eqmq.csv",sep=",",header=TRUE)
...
#pdf("Fig8_29.pdf",width=cx,height=cy)
...
#determina os limites minimo (exceto code) e maximo
